//! Utility methods to spawn a number of [scoped](https://doc.rust-lang.org/stable/std/thread/fn.scope.html)
//! threads equals to the number of cores on the machine.
//!
//! Unlike normal threads, scoped threads can borrow data from their
//! environment.
//!
